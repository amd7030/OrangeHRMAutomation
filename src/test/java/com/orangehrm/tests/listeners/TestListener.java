package com.orangehrm.tests.listeners;
...
import com.orangehrm.tests.listeners.RetryAnalyzer;

public class TestListener implements ITestListener, IAnnotationTransformer {

    @Override
    public void transform(ITestAnnotation annotation, Class testClass, Constructor testConstructor, Method testMethod) {
        annotation.setRetryAnalyzer(RetryAnalyzer.class); //RetryAnalyzer running in ApiTest.java
    }
    ...
    public void onTestSuccess(ITestResult result) {
        ...
        if (!result.getTestClass().getName().toLowerCase().contains("api")) {
            ExtentManager.logStepWithScreenshot(Base.getDriver(), "Test Passed Successfully!",
    ...
    public void onTestFailure(ITestResult result) {
        ...
        if(!result.getTestClass().getName().toLowerCase().contains("api")) {
            ExtentManager.logFailure(Base.getDriver(), "Test Failed!", "Test End: " + testName + " - ❌ Test Failed");
        }
        else {
